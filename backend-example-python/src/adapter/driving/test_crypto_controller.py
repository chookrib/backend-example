...
@router.post("/api/test/crypto/jwt-encode")
...
@router.post("/api/test/crypto/jwt-decode")
...
@router.get("/api/test/crypto/base64-encode")
...
@router.get("/api/test/crypto/base64-decode")
...
@router.get("/api/test/crypto/md5-encode")
